...
- Name: ab-testing.spec.js >> A/B Testing for Campaign Modal >> 1. Check Campaign Settings Page Loads
- Location: tests/e2e/ab-testing.spec.js:19:3
...
Locator: locator('h2:has-text("Campaign Settings")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h2:has-text("Campaign Settings")')
...
- main:
  ...
  - text: v3.7.2
  - link "Overview":
    - /url: "?page=wps-rwpr-setting&nonce=ad8bf70d9f&tab=overview-setting"
  - link "General":
    - /url: "?page=wps-rwpr-setting&nonce=ad8bf70d9f&tab=general-setting"
  - link "Per Currency Points & Coupon Settings":
    - /url: "?page=wps-rwpr-setting&nonce=ad8bf70d9f&tab=coupon-setting"
  - link "Points Table":
    - /url: "?page=wps-rwpr-setting&nonce=ad8bf70d9f&tab=points-table"
  - link "Transaction Log":
    - /url: "?page=wps-rwpr-setting&nonce=ad8bf70d9f&tab=transaction-log"
  - link "At-Risk Customers":
    - /url: "?page=wps-rwpr-setting&nonce=ad8bf70d9f&tab=churn-customers"
  - link "Points Notification":
    - /url: "?page=wps-rwpr-setting&nonce=ad8bf70d9f&tab=points-notification"
  - link "Membership":
    - /url: "?page=wps-rwpr-setting&nonce=ad8bf70d9f&tab=membership"
  - button "More ▾"
  - text: Settings
