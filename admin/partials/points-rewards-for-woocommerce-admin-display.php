...
$wps_wpr_active_version = ! empty( $wps_wpr_active_version ) ? 'v' . $wps_wpr_active_version : '';
$wps_wpr_active_type    = $wps_wpr_is_pro_active ? __( 'Pro', 'points-and-rewards-for-woocommerce' ) : __( 'Lite', 'points-and-rewards-for-woocommerce' );
...
<div class="wrap woocommerce wps-rma-admin-wrap" id="wps_rwpr_setting_wrapper" data-wps-rma-active-tab="<?php echo esc_attr( $wps_wpr_active_tab ); ?>">
	<form enctype="multipart/form-data" action="" id="mainform"  method="post">
		...
		<div class="wps_rma_notice_strips">
			<div class="wps_rma_notice_strip wps_rma_notice_strip--highlight">
				<span class="wps_rma_badge"><?php esc_html_e( 'New Layout', 'points-and-rewards-for-woocommerce' ); ?></span>
				<div class="wps_rma_notice_text">
					<strong><?php esc_html_e( 'Aurora Luxe is now available across your RMA flows', 'points-and-rewards-for-woocommerce' ); ?></strong>
					<p><?php esc_html_e( 'You can now enable the Aurora Luxe template for Refund, Exchange, Cancel, and Order Message.', 'points-and-rewards-for-woocommerce' ); ?></p>
				</div>
				<button type="button" class="wps_rma_notice_dismiss"><?php esc_html_e( 'Dismiss', 'points-and-rewards-for-woocommerce' ); ?></button>
			</div>
			<div class="wps_rma_notice_strip wps_rma_notice_strip--status">
				...
				<p><?php echo $wps_wpr_is_pro_active ? esc_html__( 'Points and Rewards for WooCommerce Pro', 'points-and-rewards-for-woocommerce' ) : esc_html__( 'Points and Rewards for WooCommerce Lite', 'points-and-rewards-for-woocommerce' ); ?></p>
				<span class="wps_rma_plugin_version_top"><?php echo esc_html( trim( $wps_wpr_active_version . ' ' . $wps_wpr_active_type ) ); ?></span>
			</div>
		</div>
				...
				<div class="wps_rma_dashboard_layout <?php echo esc_attr( $wps_wpr_active_tab_class ); ?>">
					...
					<aside class="wps_rma_right_sidebar">
						<div class="wps_rma_side_card">
							...
							<a href="https://www.youtube.com/watch?v=9BFowjkTU2Q" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Watch Video', 'points-and-rewards-for-woocommerce' ); ?></a>
							<a href="https://docs.wpswings.com/points-and-rewards-for-woocommerce/?utm_source=wpswings-par-doc&utm_medium=par-org-backend&utm_campaign=doc" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Documentation', 'points-and-rewards-for-woocommerce' ); ?></a>
							<a href="https://wpswings.com/submit-query/" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Support', 'points-and-rewards-for-woocommerce' ); ?></a>
						</div>
						...
						<div class="wps_rma_side_card">
							...
							<a href="https://wpswings.com/woocommerce-plugins/?utm_source=wpswings-par-shop&utm_medium=par-pro-backend&utm_campaign=shop-page" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'View More Plugins', 'points-and-rewards-for-woocommerce' ); ?></a>
						</div>
					</aside>
				</div>
			</div>
