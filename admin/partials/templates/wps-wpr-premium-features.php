...
?>
<div class="wps_wpr_premium__wrapper">
		<div class="wps_wpr_premium__container">
			<!--=====================================
			=            UPGRADE SECTION            =
			======================================-->
			<div class="wps_wpr_premium_upgrade">
				<div class="wps_wpr_premium_upgrade__wrapper">
					<div class="wps_wpr_premium_upgrade_desc">
						...
						<p class="wps_wpr_premium-body"><?php esc_html_e( 'and enjoy the plugin\'s best features!', 'points-and-rewards-for-woocommerce' ); ?>
						</p>
					</div>
			...
			<div class="wps_wpr_premium__row">
				...
				<div class="wps_wpr_premium__column">
					<div class="wps_wpr_premium__content">
						<h3 class="wps_wpr_premium__heading"><?php esc_html_e( 'Order total points for multiple ranges', 'points-and-rewards-for-woocommerce' ); ?></h3>
						<p class="wps_wpr_premium__text"><?php esc_html_e( 'Define different points for multiple ranges and can provide points to the customer on different order totals according to the ranges defined.', 'points-and-rewards-for-woocommerce' ); ?></p>
					</div>
				</div>
			</div>
			<div class="wps_wpr_premium__row">
			...
			<div class="wps_wpr_premium__row">
				...
				<div class="wps_wpr_premium__column">
					<div class="wps_wpr_premium__content">
						<h3 class="wps_wpr_premium__heading"><?php esc_html_e( 'Import Users Points', 'points-and-rewards-for-woocommerce' ); ?></h3>
						<p class="wps_wpr_premium__text"><?php esc_html_e( 'The admin can also manually update the customer’s points using import features.', 'points-and-rewards-for-woocommerce' ); ?></p>
					</div>
				</div>
			</div>
			<div class="wps_wpr_premium__row">
				...
				<div class="wps_wpr_premium__column">
					<div class="wps_wpr_premium__content">
						<h3 class="wps_wpr_premium__heading"><?php esc_html_e( 'Point Usage Limitation', 'points-and-rewards-for-woocommerce' ); ?></h3>
						<p class="wps_wpr_premium__text"><?php esc_html_e( 'Restrict the customers to redeem limited points per order.', 'points-and-rewards-for-woocommerce' ); ?></p>
					</div>
				</div>
			</div>
			<!--=====================================
