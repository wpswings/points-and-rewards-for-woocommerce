			...
			<section>
				<article>
					...
					<div class="wps_wpr_select_win_wheel_wrapper">
						...
						<span class="wps_wpr_select_win_wheel_page_notices wps_wpr_label_notice"><?php esc_html_e( 'Choose Win Wheel Page', 'ultimate-woocommerce-points-and-rewards' ); ?></span>
					</div>
				</article>
			</section>
			<section>
				<article>
					<label for="wps_wpr_select_spin_stop"><?php esc_html_e( 'Choose Segment To Stop Spinner', 'ultimate-woocommerce-points-and-rewards' ); ?></label>
					<div class="wps_wpr_select_win_wheel_wrapper">
						...
						<span class="wps_wpr_select__spin_stop_notices wps_wpr_label_notice"><?php esc_html_e( 'Choose Segment on which spinner is stop, else it will stop randomly', 'ultimate-woocommerce-points-and-rewards' ); ?></span>
					</div>
				</article>
			</section>
			<section>
