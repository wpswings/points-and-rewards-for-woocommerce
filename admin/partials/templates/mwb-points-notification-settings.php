...
$mwb_settings = array(
	array(
		'title' => __( 'Enable Points Notification Settings', 'points-rewards-for-woocommerce' ),
		'type'  => 'title',
	),
	array(
		...
		'class'             => 'input-text',
		'desc_tip'      => __( 'Check this box to enable the points notification.', 'points-rewards-for-woocommerce' ),
		'desc'          => __( 'Enable Points Notification', 'points-rewards-for-woocommerce' ),
	),
	array(
		'type'  => 'sectionend',
	),
	array(
		'title' => __( "Points table's Custom Points Notification Settings", 'points-rewards-for-woocommerce' ),
		'type'  => 'title',
	),
	array(
		...
		'default'   => __( 'Custom Points Notification', 'points-rewards-for-woocommerce' ),
	),
	array(
		...
		'desc'          => __( 'Use ', 'points-rewards-for-woocommerce' ) . '[Total Points]' . __( ' shortcode in place of Total Points, ', 'points-rewards-for-woocommerce' ) . '[USERNAME]' . __( ' shortcode in place of username and ', 'points-rewards-for-woocommerce' ) . __( 'in this section donot use ', 'points-rewards-for-woocommerce' ) . '[Points]' . __( ' shortcode ', 'points-rewards-for-woocommerce' ),
		'default'   => __( 'Your points are updated and your total points are ', 'points-rewards-for-woocommerce' ) . '[Total Points].',
	),
	array(
		'type'  => 'sectionend',
	),
	array(
		'title' => __( 'Signup Points Notification Settings', 'points-rewards-for-woocommerce' ),
		'type'  => 'title',
	),
	array(
		'title'         => __( 'Email Subject', 'points-rewards-for-woocommerce' ),
		...
		'class'             => 'input-text',
		'desc_tip'      => __( 'Input subject for email.', 'points-rewards-for-woocommerce' ),
		'default'   => __( 'Signup Points Notification', 'points-rewards-for-woocommerce' ),
	),
	array(
		'title'         => __( 'Email Description', 'points-rewards-for-woocommerce' ),
		'type'          => 'textarea_email',
	...
	array(
		'title' => __( 'Product Purchase Points Notification Settings', 'points-rewards-for-woocommerce' ),
		'type'  => 'title',
	),
	array(
		'title'         => __( 'Email Subject', 'points-rewards-for-woocommerce' ),
		...
		'class'             => 'input-text',
		'desc_tip'      => __( 'Input subject for email.', 'points-rewards-for-woocommerce' ),
		'default'   => __( 'Product Purchase Points Notification', 'points-rewards-for-woocommerce' ),
	),
	array(
		'title'         => __( 'Email Description', 'points-rewards-for-woocommerce' ),
		'type'          => 'textarea_email',
	...
	array(
		'title' => __( 'Order Amount Points Notification Settings(Per ', 'points-rewards-for-woocommerce' ) . get_woocommerce_currency_symbol() . __( ' Spent Points)', 'points-rewards-for-woocommerce' ),
		'type'  => 'title',
	),
	array(
		'title'         => __( 'Email Subject', 'points-rewards-for-woocommerce' ),
		...
		'class'             => 'input-text',
		'desc_tip'      => __( 'Input subject for email.', 'points-rewards-for-woocommerce' ),
		'default'   => __( 'Order Amount Points Notification', 'points-rewards-for-woocommerce' ),
	),
	array(
		'title'         => __( 'Email Description', 'points-rewards-for-woocommerce' ),
		'type'          => 'textarea_email',
	...
	array(
		'title' => __( 'Referral Points Notification Settings', 'points-rewards-for-woocommerce' ),
		'type'  => 'title',
	),
	array(
		'title'         => __( 'Email Subject', 'points-rewards-for-woocommerce' ),
		...
		'class'             => 'input-text',
		'desc_tip'      => __( 'Input subject for email.', 'points-rewards-for-woocommerce' ),
		'default'   => __( 'Referral Points Notification', 'points-rewards-for-woocommerce' ),
	),
	array(
		'title'         => __( 'Email Description', 'points-rewards-for-woocommerce' ),
		'type'          => 'textarea_email',
	...
	array(
		...
		'class'             => 'input-text',
		'desc_tip'      => __( 'Input subject for email.', 'points-rewards-for-woocommerce' ),
		'default'   => __( 'Upgrade Membership Level Notification', 'points-rewards-for-woocommerce' ),
	),
	array(
		'title'         => __( 'Email Description', 'points-rewards-for-woocommerce' ),
		'type'          => 'textarea_email',
		...
		'class'             => 'input-text',
		'desc_tip'      => __( 'Enter Email Description for user.', 'points-rewards-for-woocommerce' ),
		'default'   => __( 'Your User Level has been Upgraded to [USERLEVEL]. And Now You will get some offers on some products.', 'points-rewards-for-woocommerce' ),
		'desc'          => __( 'Use ', 'points-rewards-for-woocommerce' ) . '[USERLEVEL]' . __( ' shortcode in place of User Level ', 'points-rewards-for-woocommerce' ) . '[USERNAME]' . __( ' shortcode in place of username ', 'points-rewards-for-woocommerce' ),
	),
	array(
		'type'  => 'sectionend',
	),
	array(
		'title' => __( 'Deduct Assigned Point Notification', 'points-rewards-for-woocommerce' ),
		'type'  => 'title',
	),
	array(
		'title'         => __( 'Email Subject', 'points-rewards-for-woocommerce' ),
	...
	array(
		...
		'class'             => 'input-text',
		'desc_tip'      => __( 'Input subject for email.', 'points-rewards-for-woocommerce' ),
		'default'   => __( 'Points Deducted!!', 'points-rewards-for-woocommerce' ),
	),
	array(
		'title'         => __( 'Email Description', 'points-rewards-for-woocommerce' ),
		'type'          => 'textarea_email',
		...
		'class'             => 'input-text',
		'desc_tip'      => __( 'Enter Email Description for user.', 'points-rewards-for-woocommerce' ),
		'default'   => __( 'Your [DEDUCTCARTPOINT] Points has been deducted from your account, now your Total Point are [TOTALPOINTS].', 'points-rewards-for-woocommerce' ),
	...
	array(
		'title' => __( 'Points On Order Total Range', 'points-rewards-for-woocommerce' ),
		'type'  => 'title',
	),
	array(
		'title'         => __( 'Email Subject', 'points-rewards-for-woocommerce' ),
		...
		'class'             => 'input-text',
		'desc_tip'      => __( 'Input subject for email.', 'points-rewards-for-woocommerce' ),
		'default'   => __( 'Points Added', 'points-rewards-for-woocommerce' ),
	),
	array(
		'title'         => __( 'Email Description', 'points-rewards-for-woocommerce' ),
		'type'          => 'textarea_email',
...
<div class="clear"></div>
<p class="submit">
	<input type="submit" value='<?php esc_html_e( 'Save changes', 'points-rewards-for-woocommerce' ); ?>' class="button-primary woocommerce-save-button mwb_wpr_save_changes" name="mwb_wpr_save_notification">
</p>	
