...
$wps_wpr_general_settings = array(
	...
	array(
		'title'    => __( 'Show Next Discount Milestone on Product Pages', 'points-and-rewards-for-woocommerce' ),
		'type'     => 'checkbox',
		'id'       => 'wps_wpr_show_points_notice_on_product',
		'desc_tip' => __( 'Toggle this to show how many points customers need to reach their next discount milestone on product pages', 'points-and-rewards-for-woocommerce' ),
		'class'    => 'input-text',
		'desc'     => __( 'Display "You\'re X points away from ₹Y discount" notification on product pages', 'points-and-rewards-for-woocommerce' ),
		'default'  => '',
	),
	array(
		'title'    => __( 'Show Next Discount Milestone on Cart Page', 'points-and-rewards-for-woocommerce' ),
		'type'     => 'checkbox',
		'id'       => 'wps_wpr_show_points_notice_on_cart',
		'desc_tip' => __( 'Toggle this to show how many points customers need to reach their next discount milestone on cart page', 'points-and-rewards-for-woocommerce' ),
		'class'    => 'input-text',
		'desc'     => __( 'Display "You\'re X points away from ₹Y discount" notification on cart page', 'points-and-rewards-for-woocommerce' ),
		'default'  => '',
	),
	array(
		'title'    => __( 'Show Next Discount Milestone on Checkout Page', 'points-and-rewards-for-woocommerce' ),
		'type'     => 'checkbox',
		'id'       => 'wps_wpr_show_points_notice_on_checkout',
		'desc_tip' => __( 'Toggle this to show how many points customers need to reach their next discount milestone on checkout page', 'points-and-rewards-for-woocommerce' ),
		'class'    => 'input-text',
		'desc'     => __( 'Display "You\'re X points away from ₹Y discount" notification on checkout page', 'points-and-rewards-for-woocommerce' ),
		'default'  => '',
	),
	array(
	...
	if ( wp_verify_nonce( $wps_wpr_nonce, 'wps-wpr-nonce' ) ) {
		if ( 'wps_wpr_general_setting' == $current_tab ) {
			...
			$general_settings_array = array(
				...
				'wps_wpr_show_points_notice_on_product' => ! empty( $_POST['wps_wpr_show_points_notice_on_product'] ) ? 1 : '',
				'wps_wpr_show_points_notice_on_cart'    => ! empty( $_POST['wps_wpr_show_points_notice_on_cart'] ) ? 1 : '',
				'wps_wpr_show_points_notice_on_checkout' => ! empty( $_POST['wps_wpr_show_points_notice_on_checkout'] ) ? 1 : '',
