	...
	public function wps_wpr_enqueue_dummy_file() {
		...
		if ( ! empty( $screen ) && ! empty( $screen->id ) ) {
			if ( ! empty( $_GET['page'] ) && 'wps-rwpr-setting' == $_GET['page'] ) {
				...
				wp_register_style( 'wps_wpr_dummy_css_file', WPS_RWPR_DIR_URL . 'admin/partials/dummyfile/dummycss/wps-points-and-rewards-dummy.css', array(), '2.1.2' );
				wp_enqueue_style( 'wps_wpr_dummy_css_file' );
				wp_register_script( 'wps_wpr_dummy_js_file', WPS_RWPR_DIR_URL . 'admin/partials/dummyfile/dummyjs/wps-points-and-rewards-dummy.js', array(), '2.1.2', true );
