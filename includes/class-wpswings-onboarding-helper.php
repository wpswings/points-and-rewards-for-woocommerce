...
class WPSwings_Onboarding_Helper {
	 ...
	 * @var string instance
	 */
	protected static $wps_wpr_instance = null;
	...
	public static function get_instance() {
		...
		if ( is_null( self::$wps_wpr_instance ) ) {
			...
			self::$wps_wpr_instance = new self();
		}

		return self::$wps_wpr_instance;
	}
	...
	public function enqueue_styles() {
		...
		if ( $this->is_valid_page_screen() ) {
			...
			wp_enqueue_style( 'makewebbetter-onboarding-style', WPS_RWPR_DIR_URL . 'admin/css/wpswings-onboarding-admin.css', array(), '2.5.1', 'all' );
	...
	public function enqueue_scripts() {
		...
		if ( $this->is_valid_page_screen() ) {
			...
			wp_enqueue_script( 'makewebbetter-onboarding-scripts', WPS_RWPR_DIR_URL . 'admin/js/wpswings-onboarding-admin.js', array( 'jquery', 'select2' ), '2.5.1', true );
	...
	public function render_field_html( $attr = array(), $base_class = 'on-boarding' ) {
		...
		if ( 'hidden' != $type ) : ?>
			<div class ="wps-form-single-field">
			<?php
		endif;
