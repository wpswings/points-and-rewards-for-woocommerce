...
if ( $activated ) {
	...
	function rewardeem_woocommerce_points_rewards_auto_update() {
		...
		$update_check = 'https://makewebbetter.com/pluginupdates/points-rewards-for-woocommerce/update.php';
		require_once( 'points-rewards-for-woocommerce-update.php' );
	}
	...
	function rewardeem_woocommerce_points_rewards_settings_link( $links ) {
		...
		$my_link = array(
			'<a href="' . admin_url( 'admin.php?page=mwb-rwpr-setting' ) . '">' . __( 'Settings', 'points-rewards-for-woocommerce' ) . '</a>',
		);
