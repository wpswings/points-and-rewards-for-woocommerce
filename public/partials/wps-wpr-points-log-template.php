...
if ( isset( $user_id ) && null != $user_id && is_numeric( $user_id ) ) {
	...
	if ( isset( $point_log ) && is_array( $point_log ) && null != $point_log ) {
		...
		if ( array_key_exists( 'gift_card_awarded_points', $point_log ) ) {
			?>
			<div class="wps_wpr_slide_toggle">
				<p class="wps_wpr_view_log_notice wps_wpr_common_slider"><?php esc_html_e( 'Gift Card Awarded Points', 'points-and-rewards-for-woocommerce' ); ?><a class ="wps_wpr_open_toggle"  href="javascript:;"></a></p>
				<table class="wps_wpr_common_table">
					<thead>
						<tr>
							<th class="wps-wpr-view-log-Date">
					...
					<?php foreach ( $point_log['gift_card_awarded_points'] as $key => $value ) { ?>
						<tr>
							<td><?php echo esc_html( wps_wpr_set_the_wordpress_date_format( $value['date'] ) ); ?></td>
							<td><?php echo '+' . esc_html( $value['gift_card_awarded_points'] ); ?></td>
						</tr>
						<?php
					}
					?>
		...
		if ( array_key_exists( 'gift__card_points_refunded', $point_log ) ) {
			?>
			<div class="wps_wpr_slide_toggle">
				<p class="wps_wpr_view_log_notice wps_wpr_common_slider"><?php esc_html_e( 'Gift Card Points Refunded', 'points-and-rewards-for-woocommerce' ); ?><a class ="wps_wpr_open_toggle"  href="javascript:;"></a></p>
				<table class="wps_wpr_common_table">
					<thead>
						<tr>
							<th class="wps-wpr-view-log-Date">
					...
					<?php foreach ( $point_log['gift__card_points_refunded'] as $key => $value ) { ?>
						<tr>
							<td><?php echo esc_html( wps_wpr_set_the_wordpress_date_format( $value['date'] ) ); ?></td>
							<td><?php echo '-' . esc_html( $value['gift__card_points_refunded'] ); ?></td>
						</tr>
						<?php
					}
					?>
