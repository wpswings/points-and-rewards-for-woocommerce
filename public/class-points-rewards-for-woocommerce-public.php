...
class Points_Rewards_For_WooCommerce_Public {
	...
	public function order_conversion_rate() {
		...
		$order_conversion_rate_value  = $this->mwb_wpr_get_coupon_settings_num( 'mwb_wpr_coupon_conversion_points' );
		$order_conversion_rate_points = $this->mwb_wpr_get_coupon_settings_num( 'mwb_wpr_coupon_conversion_price' );
